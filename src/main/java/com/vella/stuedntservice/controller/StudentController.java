...
public class StudentController {
  ...
  @PostMapping("/save")
  public Student saveStudent(@RequestBody StudentCreateRequest request) throws CustomErrorException{
    return studentService.saveStudent(request);
  }

  @PutMapping("/{id}/update")
  public Student updateStudent(@PathVariable Long id, @RequestBody StudentCreateRequest request) throws CustomErrorException, IOException {
  ...
  public List<Grades> getGradesForStudentForSubject(@PathVariable Long studentId, @RequestBody SubjectCreateRequest request) throws CustomErrorException {
